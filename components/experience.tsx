...
const experiencesData: Omit<Experience, 'startDate' | 'endDate'>[] = [
  {
    ...
    company: "OnTime Transport",
    period: "May 2026 - Present",
    type: "Part-time",
    summary: "Provide NREMT-certified BLS care during inter-facility and non-emergency medical transports — conducting patient assessments, monitoring vitals, and delivering clinical handoffs to receiving facilities.",
    description: [
      "Provide BLS patient care during inter-facility and non-emergency medical transports — conducting patient assessments, monitoring vital signs, and delivering structured clinical handoffs to receiving facilities",
      "Apply NREMT-certified protocols and standard of care across varied patient acuity levels, ensuring patient safety, dignity, and continuity of care throughout the transport workflow",
      "Document patient encounters with accurate, HIPAA-compliant Patient Care Reports (PCRs), and complete pre-shift rig and equipment readiness checks to maintain operational compliance",
      "Collaborate with paramedics, nurses, and dispatch teams to coordinate timely transports and respond effectively to dynamic patient needs in time-sensitive environments",
    ],
    skills: ["Patient Assessment", "BLS", "NREMT Protocols", "Vitals Monitoring", "Patient Care Reporting (PCR)", "HIPAA", "Inter-Facility Transport", "Clinical Handoff"],
    narrative: "Working as an EMT in active inter-facility transport is the most patient-facing thing I do. Every transport is a self-contained clinical episode — pre-shift equipment checks, patient assessment, vital monitoring throughout, HIPAA-compliant PCR documentation, and a structured clinical handoff at the receiving facility. What I didn't expect was how much of the job is information management: capturing accurate baseline vitals, tracking changes in transit, and delivering a clear handoff that the receiving facility can act on immediately. The discipline of that information chain — accurate input, reliable processing, clean output — is the same discipline I apply to data pipelines. EMT work also keeps me grounded in what users of healthcare systems actually experience, which directly informs how I think about AI applied to medical contexts.",
  },
  {
    id: 1,
    title: "PSSP Assistant Team Lead — Window Program",
    company: "Purdue University Police Department",
    period: "September 2025 - Present",
    type: "Part-time",
    summary: "Lead administrative operations and scheduling for the PUPD Window Program — owning shift coverage, process improvement, and patroller onboarding while serving as the escalation point between patrol staff and officers.",
    description: [
      "Lead administrative operations and day-to-day workflow management for the Purdue University Police Department's Window Program, overseeing front-desk operations, public-facing service requests, and coordination between civilian staff and sworn officers",
      "Own end-to-end shift coverage and scheduling for the patroller team, balancing personnel availability against fluctuating staffing demands to maintain 100% coverage of critical posts and zero unstaffed shifts",
      "Spearheaded a process-improvement project to overhaul appointment-based fingerprinting operations — designed a staffing model and scheduling protocol that guarantees a trained patroller is on site for every scheduled appointment, eliminating service gaps",
      "Train and onboard incoming patrollers on department SOPs, front-desk protocols, and customer service standards — accelerating ramp-up and driving consistent service quality across all shifts",
      "Serve as the primary escalation point between patrollers and full-time officers, triaging incoming requests and routing complex issues to appropriate department personnel",
    ...
    skills: ["Operations Management", "Scheduling", "Process Improvement", "Team Leadership", "Risk Assessment", "Security Operations", "Onboarding", "Compliance Documentation"],
    narrative: "Being promoted to Assistant Team Lead changed what the job was about. As a patroller I executed protocols; as a team lead, I own the protocols — scheduling coverage to hit zero unstaffed shifts, redesigning the fingerprinting appointment process to eliminate service gaps, and training incoming patrollers to maintain consistent quality. The fingerprinting process improvement was a classic operations problem: appointments were being missed because scheduling didn't guarantee a trained patroller on site. I mapped the failure mode, designed a staffing model that closed the gap, and documented it as SOP. That's the same problem-solving approach I use in software — identify the constraint, design around it, document the fix so it doesn't reopen.",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    type: "Clinical",
    summary: "Completed 12-hour emergency department rotation observing and assisting with EMT functions across live ER intake and patient care workflows.",
    description: [
      "Completed a 12-hour emergency department clinical rotation, observing and assisting with EMT functions within a hospital setting across live ER intake and patient care workflows",
  ...
  },
  {
    ...
    period: "October 2025 - December 2025",
    type: "Clinical",
    summary: "Completed 12-hour field ride-along responding to live emergency calls alongside certified EMTs and paramedics in pre-hospital EMS.",
    description: [
      "Completed a 12-hour field ride-along with the local Lafayette EMS system, responding to live emergency calls alongside certified EMTs and paramedics in a pre-hospital environment",
